...
- **Creation:** Generated by the ObjectBox Gradle plugin on the first build of `:core:persistence`
- **Version Control:** ✅ Once generated, this file **MUST** be added and committed to VCS (Git)
- **Purpose:** Maintains stable IDs to prevent schema migration issues
- **Note:** In a fresh clone, this file may not exist until you run a build that processes the ObjectBox entities
