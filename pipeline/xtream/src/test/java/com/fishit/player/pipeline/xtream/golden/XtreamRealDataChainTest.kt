...
class XtreamRealDataChainTest {
    ...
    private fun assertGoldenChain(
        ...
        val compositeElement =
            FullChainStepSerializer.toCompositeJson(
     ...
     */
    private fun extractJsonArrayItem(
        fileName: String,
        index: Int,
    ): String {
    ...
    @Test
    fun `VOD chain - first item from real vod_streams json`() =
        runTest {
    ...
    @Test
    fun `VOD chain - item with empty rating and no icon (edge case)`() =
        runTest {
    ...
    @Test
    fun `VOD chain - item with pipe-separated title format (edge case)`() =
        runTest {
    ...
    @Test
    fun `VOD detail chain - 36 China Town real detail response`() =
        runTest {
    ...
    @Test
    fun `Series chain - first valid item from real series json`() =
        runTest {
    ...
    @Test
    fun `Series chain - item with negative series_id (edge case)`() =
        runTest {
    ...
    @Test
    fun `Episode chain - first episode from real series detail`() =
        runTest {
    ...
    @Test
    fun `Live channel chain - first item from real live_streams json`() =
        runTest {
    ...
    @Test
    fun `Live channel chain - item with Unicode decorators (edge case)`() =
        runTest {
            // Find live channel with Unicode block decorators (▃ ▅ ▆ █ etc.)
            val index =
                liveStreams.indexOfFirst {
    ...
    @Test
    fun `Live channel chain - item with catchup (tv_archive=1)`() =
        runTest {
    ...
    @Test
    fun `VOD chain consistency - first 5 items all produce valid NX entities`() =
        runTest {
