...
object FullChainStepSerializer {
    ...
    fun parseGoldenFile(jsonString: String): JsonElement =
    ...
    fun vodItemToJson(dto: XtreamVodItem): JsonElement = buildJsonObject {
        put("id", dto.id)
        put("name", dto.name)
    ...
    fun seriesItemToJson(dto: XtreamSeriesItem): JsonElement = buildJsonObject {
        put("id", dto.id)
        put("name", dto.name)
    ...
    fun channelToJson(dto: XtreamChannel): JsonElement = buildJsonObject {
        put("id", dto.id)
        put("name", dto.name)
        putNullableString("streamIcon", dto.streamIcon)
    ...
    fun episodeToJson(dto: XtreamEpisode): JsonElement = buildJsonObject {
        put("id", dto.id)
    ...
    fun normalizedToJson(n: NormalizedMediaMetadata): JsonElement = buildJsonObject {
        // Identity
        ...
        put("externalIds", buildJsonObject {
            ...
            putNullableString("tmdbType", n.externalIds.tmdb?.type?.name)
