 ...
 */
@Singleton
class XtreamPipelineAdapter @Inject constructor(
...
private fun XtreamVodStream.toPipelineItem(): XtreamVodItem = XtreamVodItem(
    id = resolvedId,
    name = name.orEmpty(),
...
private fun XtreamSeriesStream.toPipelineItem(): XtreamSeriesItem = XtreamSeriesItem(
    id = resolvedId,
    name = name.orEmpty(),
    cover = resolvedCover,
    categoryId = categoryId,
...
private fun XtreamLiveStream.toPipelineItem(): XtreamChannel = XtreamChannel(
    id = resolvedId,
    name = name.orEmpty(),
        ...
        episodeList.forEach { ep ->
            result.add(
                XtreamEpisode(
                    ...
                    thumbnail = ep.info?.movieImage ?: ep.info?.posterPath ?: ep.info?.thumbnail
                )
            )
        }
    }
