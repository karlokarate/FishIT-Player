...
class TelegramCatalogPipelineImpl @Inject constructor(
    ...
    override fun scanCatalog(config: TelegramCatalogConfig): Flow<TelegramCatalogEvent> = flow {
        ...
        try {
            ...
            val chatsToScan = if (config.includedChatIds.isNotEmpty()) {
            ...
            for (chat in chatsToScan) {
                ...
                try {
                    val chatMessages = scanChat(chat, config)
     ...
     */
    private suspend fun Flow.Collector<TelegramCatalogEvent>.scanChat(
        ...
        while (cursor.hasNext()) {
            ...
            for (message in messages) {
                ...
                val shouldInclude = when (mediaKind) {
                ...
                if (rawMetadata != null) {
                    ...
                    emit(TelegramCatalogEvent.ItemDiscovered(item))
                }
