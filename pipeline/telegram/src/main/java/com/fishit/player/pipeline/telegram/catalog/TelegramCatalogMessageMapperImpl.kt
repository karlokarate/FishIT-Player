 ...
 */
class TelegramCatalogMessageMapperImpl @Inject constructor() : TelegramCatalogMessageMapper {
     ...
     */
    private fun buildSourceId(chatId: Long, messageId: Long, uniqueId: String): String {
        return "tg:$chatId:$messageId:$uniqueId"
    }
    ...
    private fun buildTelegramUri(
        ...
        return "tg://file/$fileId?chatId=$chatId&messageId=$messageId&remoteId=$remoteId&uniqueId=$uniqueId"
    }
