 ...
 *
 * @return RawMediaMetadata with Telegram-specific fields
 */
 ...
 */
private fun TelegramMediaItem.extractRawTitle(): String = when {
 ...
 */
private fun TelegramMediaItem.mapTelegramMediaType(): MediaType = when {
 ...
 */
private fun TelegramMediaItem.buildTelegramSourceLabel(): String = when {
