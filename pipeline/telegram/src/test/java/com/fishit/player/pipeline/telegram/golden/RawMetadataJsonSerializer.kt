 ...
 *
 * **NOTE:** Copy of pipeline/xtream golden serializer. Kept as local copy because test
 * sourceSets cannot be shared across Android library modules without a dedicated test-fixtures
 * module. If a third pipeline needs this, consider extracting to a shared test-utils module.
 *
 * **Design decisions:**
