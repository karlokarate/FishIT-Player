...
class LoadSeriesSeasonsUseCase
    ...
    constructor(
        ...
        suspend fun ensureSeasonsLoaded(
            ...
            val seasons =
                seriesInfo.seasons?.mapNotNull { season ->
        ...
        suspend fun invoke(
            ...
            return try {
                withTimeout(ENRICHMENT_TIMEOUT_MS) {
                    val seriesInfo =
                        apiClient.getSeriesInfo(seriesId)
