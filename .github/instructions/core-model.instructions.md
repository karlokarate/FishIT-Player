...
1. `/contracts/MEDIA_NORMALIZATION_CONTRACT.md` - Section 1.1, 2.1 (AUTHORITATIVE)
...
4. `/contracts/TMDB_ENRICHMENT_CONTRACT.md` - TmdbRef, TmdbResolveState (AUTHORITATIVE)
