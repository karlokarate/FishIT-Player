...
class DiagnosticsLoggerTest {
    ...
    @Test
    fun `logEvent creates event with correct properties`() =
        runBlocking {
    ...
    @Test
    fun `sensitive data is filtered from metadata`() =
        runBlocking {
            DiagnosticsLogger.logEvent(
                category = "test",
                event = "test_event",
    ...
    @Test
    fun `log level filtering works correctly`() =
        runBlocking {
    ...
    @Test
    fun `logError creates event with exception details`() =
        runBlocking {
    ...
    @Test
    fun `exportEventsAsJson returns valid JSON`() =
        runBlocking {
            DiagnosticsLogger.logEvent(
                category = "test",
                event = "test_event",
    ...
    @Test
    fun `Xtream helper logs correctly`() =
        runBlocking {
    ...
    @Test
    fun `Media3 helper logs correctly`() =
        runBlocking {
    ...
    @Test
    fun `ComposeTV helper logs correctly`() =
        runBlocking {
    ...
    @Test
    fun `disabled logger does not log events`() =
        runBlocking {
