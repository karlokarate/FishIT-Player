...
/**
 * Download progress information for a file (Refactor version).
 */
data class DownloadProgressRefactor(
    val fileId: Int,
 ...
 */
class T_TelegramFileDownloaderRefactor(
     ...
     */
    fun observeDownloadProgress(fileId: Int): Flow<DownloadProgressRefactor> =
        client.fileUpdates
     ...
     */
    suspend fun getCurrentProgress(fileId: Int): DownloadProgressRefactor? =
        withContext(Dispatchers.IO) {
