...
enum class AppIcon {
    Refresh, Profile, Settings, LiveTv, MovieVod, Series, All,
    PlayCircle, Restart, Play, Info,
    AddKid, RemoveKid, BookmarkAdd, BookmarkRemove,
    Search, AddProfile, Edit, Lock, Kids, Camera, Gallery
}

@DrawableRes
fun AppIcon.resId(variant: IconVariant = IconVariant.Primary): Int = when (this) {
