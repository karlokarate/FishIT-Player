...
private fun gradient(a: Color, b: Color) = Brush.linearGradient(listOf(a, b))

@Composable
fun CategoryChip(key: String, label: String, modifier: Modifier = Modifier) {
    val style = remember(key) {
    ...
    val adultBorderAccent = remember(key) {
    ...
    Surface(
        ...
        modifier = modifier
            .drawBehind {
                if (style.drip) {
                    ...
                    drawCircle(color = dripColor, radius = r, center = androidx.compose.ui.geometry.Offset(size.width * 0.25f, y))
                    drawCircle(color = dripColor, radius = r * 1.2f, center = androidx.compose.ui.geometry.Offset(size.width * 0.5f, y))
                    drawCircle(color = dripColor, radius = r * 0.9f, center = androidx.compose.ui.geometry.Offset(size.width * 0.75f, y))
                }
                if (style.caution) {
                    val bandH = 6.dp.toPx()
                    val step = 12.dp.toPx()
                    ...
                    fun drawBand(y: Float) {
                        withTransform({ translate(left = 0f, top = y); rotate(degrees = -20f) }) {
                            var x = -size.width
                            var flag = true
                            while (x < size.width * 2) {
                                drawRect(color = if (flag) yellow else black, topLeft = androidx.compose.ui.geometry.Offset(x, 0f), size = androidx.compose.ui.geometry.Size(step, bandH))
                                x += step
                                flag = !flag
                            }
                        }
        ...
        Row(
            ...
            Text(
                text = label,
                style = if (style.bold) MaterialTheme.typography.labelLarge.copy(color = style.textColor, fontWeight = FontWeight.SemiBold, fontFamily = font)
                else MaterialTheme.typography.labelLarge.copy(color = style.textColor, fontFamily = font)
            )
        }
    }
}
...
private val styles: Map<String, ChipStyle> = mapOf(
    // meta
    "recent" to ChipStyle(textColor = Color(0xFFF59E0B), bg = gradient(Color(0xFF1B1B1B), Color(0xFF111111)), borderColor = Color(0x42F59E0B)),
    ...
    "anime" to ChipStyle(textColor = Color(0xFF3A0A21), bg = gradient(Color(0xFFFFDEF0), Color(0xFFFFC7E6)), borderColor = Color(0x59FF4DA6)),
    "bollywood" to ChipStyle(textColor = Color(0xFF432000), bg = gradient(Color(0xFFFFD580), Color(0xFFFFAA00)), borderColor = Color(0x59FFAA00)),
    "classic" to ChipStyle(textColor = Color(0xFFEADAA6), bg = gradient(Color(0xFF1A1A1A), Color(0xFF101010)), borderColor = Gold.copy(alpha = 0.45f)),
    "documentary" to ChipStyle(textColor = Color(0xFFDCE6FF), bg = gradient(Navy, NavyDark), borderColor = Color(0x591E3A8A)),
    "drama" to ChipStyle(textColor = Color(0xFFFFE6EF), bg = gradient(Color(0xFF4A0F24), Color(0xFF340A19)), borderColor = Burgund.copy(alpha = 0.3f)),
    "family" to ChipStyle(textColor = Color(0xFF3E2A00), bg = gradient(Color(0xFFFFE5A3), Color(0xFFF6C453)), borderColor = Color(0x59F6C453)),
    "fantasy" to ChipStyle(textColor = Color(0xFFF3E8FF), bg = gradient(Color(0xFF4B1FA4), Amethyst), borderColor = Color(0x59B794F4)),
    "horror" to ChipStyle(textColor = Blood, bg = gradient(Color(0xFF1B0A0D), Color(0xFF110507)), borderColor = Blood.copy(alpha = 0.4f), drip = true),
    "kids" to ChipStyle(textColor = Color(0xFF08343B), bg = gradient(Color(0xFFA5F3FC), Color(0xFF67E8F9)), borderColor = Color(0x5906B6D4)),
    "comedy" to ChipStyle(textColor = Color(0xFF3A2900), bg = gradient(Color(0xFFFFE08A), Color(0xFFFFC400)), borderColor = Color(0x59FFC400)),
    "war" to ChipStyle(textColor = Color(0xFFF2F2F2), bg = gradient(Color(0xFF4B5320), Color(0xFF6B8E23)), borderColor = Color(0x52A4B87A)),
    "martial_arts" to ChipStyle(textColor = Color.White, bg = gradient(Color(0xFFB71C1C), Color(0xFFD32F2F)), borderColor = Color(0x51E57373)),
    "romance" to ChipStyle(textColor = Color.White, bg = gradient(Color(0xFFEC407A), Color(0xFFC2185B)), borderColor = Color(0x55F48FB1)),
    ...
    "thriller" to ChipStyle(textColor = Color(0xFFEAEAEA), bg = gradient(Color(0xFF1F2937), Color(0xFF111827)), borderColor = Color(0x48C62828)),
    "christmas" to ChipStyle(textColor = Color.White, bg = gradient(Pine, PineDark), borderColor = Color(0x4DE53935)),
    "western" to ChipStyle(textColor = Color(0xFFF9E7D0), bg = gradient(Color(0xFF8B4513), Color(0xFF5D3111)), borderColor = Color(0x59CFA277)),
    // specials
