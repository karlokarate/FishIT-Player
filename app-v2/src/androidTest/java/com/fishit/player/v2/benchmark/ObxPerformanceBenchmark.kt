...
class ObxPerformanceBenchmark {
    ...
    fun setup() {
        ...
        // Note: MyObjectBox is auto-generated by ObjectBox annotation processor from @Entity classes
    ...
    fun benchmark_batchWrite_1000Items() {
        ...
        repeat(5) {
            ...
            val timeMs = measureTimeMillis {
                // Use standard put() method - ObjectBox handles batching internally
                canonicalMediaBox.put(items)
            }
            timings.add(timeMs)
        }
