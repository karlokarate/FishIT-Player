...
class CatalogSyncOrchestratorWorker @AssistedInject constructor(
    ...
    private fun buildChildInputData(
        ...
        .putString(
            ...
            parentInput.telegramSyncKind ?: WorkerConstants.TELEGRAM_KIND_INCREMENTAL
        )
        .putString(
    ...
    private fun buildXtreamChain(inputData: Data): List<OneTimeWorkRequest> = listOf(
    ...
    private fun buildTelegramChain(inputData: Data, parentInput: WorkerInputData): List<OneTimeWorkRequest> {
        val scanWorker = if (parentInput.telegramSyncKind == WorkerConstants.TELEGRAM_KIND_FULL_HISTORY ||
