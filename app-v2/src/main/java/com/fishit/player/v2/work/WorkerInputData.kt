...
data class WorkerInputData(
    ...
    companion object {
         ...
         */
        fun from(workerParams: WorkerParameters): WorkerInputData =
        ...
        fun from(data: Data): WorkerInputData {
            return WorkerInputData(
                ...
                activeSources = data.getStringArray(WorkerConstants.KEY_ACTIVE_SOURCES)
                    ?.toSet() ?: emptySet(),
...
object RuntimeGuards {
    ...
    fun detectDeviceClass(context: Context): String {
        val isFireTv = Build.MODEL.contains("AFT", ignoreCase = true) ||
...
object WorkerOutputData {
    ...
    fun failure(reason: String): Data = Data.Builder()
