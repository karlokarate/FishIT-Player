    ...
    constructor(
                ...
                com.fishit.player.core.model.SourceType.XTREAM -> {
                    when {
                        ...
                        sourceIdValue.startsWith("xtream:series:") -> {
                            ...
                            put(XtreamPlaybackSourceFactoryImpl.EXTRA_SERIES_ID, sourceIdValue.removePrefix("xtream:series:"))
                        }
                        ...
                        sourceIdValue.startsWith("xtream:live:") -> {
                            put(XtreamPlaybackSourceFactoryImpl.EXTRA_CONTENT_TYPE, XtreamPlaybackSourceFactoryImpl.CONTENT_TYPE_LIVE)
                            put(XtreamPlaybackSourceFactoryImpl.EXTRA_STREAM_ID, sourceIdValue.removePrefix("xtream:live:"))
                        }
                    }
        ...
        private fun mapToPlayerSourceType(sourceType: com.fishit.player.core.model.SourceType): SourceType {
            return when (sourceType) {
                ...
                com.fishit.player.core.model.SourceType.LOCAL -> SourceType.FILE
                // Unsupported sources → UNKNOWN  
                com.fishit.player.core.model.SourceType.PLEX,
                com.fishit.player.core.model.SourceType.OTHER,
                com.fishit.player.core.model.SourceType.UNKNOWN -> SourceType.UNKNOWN
            }
        }

        private fun isLiveContent(source: MediaSourceRef): Boolean {
            return source.sourceId.value.startsWith("xtream:live:")
        }
