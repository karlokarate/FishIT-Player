 ...
 */
@HiltWorker
class TmdbEnrichmentOrchestratorWorker @AssistedInject constructor(
    ...
    companion object {
        ...
        fun enqueue(
            ...
            val inputData = TmdbWorkerInputData.buildInputData(
            ...
            val policy = if (forceRefresh) {
                ExistingWorkPolicy.REPLACE
            } else {
                ExistingWorkPolicy.KEEP
            }

            val request = OneTimeWorkRequestBuilder<TmdbEnrichmentOrchestratorWorker>()
    ...
    private suspend fun determineScope(input: TmdbWorkerInputData): String? {
        ...
        return when (requestedScope) {
            WorkerConstants.TMDB_SCOPE_DETAILS_BY_ID -> {
                ...
                val detailsCandidates = canonicalMediaRepository
            ...
            WorkerConstants.TMDB_SCOPE_RESOLVE_MISSING_IDS -> {
                ...
                val searchCandidates = canonicalMediaRepository
     ...
     */
    private fun enqueueBatchWorker(input: TmdbWorkerInputData, scope: String) {
