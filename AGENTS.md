...
- Telegram UI/Playback: Library VOD zeigt per‑Chat Telegram‑Rows (Tiles mit blauem „T“-Tag). Der Serien‑Tab zeigt eine einzige aggregierte Row „Telegram Serien“, die alle synchronisierten Serien umfasst. Start’s global search enthält eine Telegram‑Row. Player nutzt geringe RAM‑Buffer für `tg://`, TDLib cached auf Disk.
