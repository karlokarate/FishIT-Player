...
**⚡ IMPORTANT - TDLib Integration (Priority 1)**: As of 2025-11-20, `.github/tdlibAgent.md` is the **Single Source of Truth** for all Telegram/TDLib integration work. All new Telegram features must follow this document. Legacy Telegram docs have been archived to `docs/archive/`.
