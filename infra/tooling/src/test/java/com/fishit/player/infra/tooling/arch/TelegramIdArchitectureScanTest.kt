...
class TelegramIdArchitectureScanTest {
    ...
    companion object {
        ...
        private val V2_SOURCE_DIRS = listOf(
        ...
        private val PERSISTENT_FILEID_PATTERNS = listOf(
    ...
    private fun scanDirectory(dir: File, violations: MutableList<ScanViolation>) {
        dir.walkTopDown()
            .filter { it.isFile && it.extension == "kt" }
    ...
    private fun scanFile(file: File, violations: MutableList<ScanViolation>, layer: LayerType) {
        val content = file.readText()
