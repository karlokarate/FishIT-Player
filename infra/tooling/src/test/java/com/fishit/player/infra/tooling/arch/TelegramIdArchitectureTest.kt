...
class TelegramIdArchitectureTest {
    companion object {
        ...
        private val FORBIDDEN_FIELD_PATTERNS =
            listOf(
    ...
    fun `TelegramMediaItem uses remoteId and thumbRemoteId`() {
        val mediaItemFile =
            File(PROJECT_ROOT, "pipeline/telegram/src/main/java/com/fishit/player/pipeline/telegram/model/TelegramMediaItem.kt")
    ...
    fun `TelegramPhotoSize uses remoteId only`() {
        val photoSizeFile =
            File(PROJECT_ROOT, "pipeline/telegram/src/main/java/com/fishit/player/pipeline/telegram/model/TelegramPhotoSize.kt")
    ...
    fun `TgThumbnailRef uses remoteId only`() {
        val thumbFetcherFile =
            File(PROJECT_ROOT, "infra/transport-telegram/src/main/java/com/fishit/player/infra/transport/telegram/TelegramThumbFetcher.kt")
    ...
    private fun extractDataClassBlock(
        content: String,
        className: String,
    ): String? {
    ...
    private fun extractEntityBlock(
        content: String,
        entityName: String,
    ): String? {
    ...
    private fun extractInterfaceBlock(
        content: String,
