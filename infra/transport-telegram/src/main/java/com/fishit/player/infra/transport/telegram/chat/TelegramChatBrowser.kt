        ...
        when (content) {
            is MessageVideo ->
                TgContent.Video(
                    ...
                    thumbnail =
                        content.video.thumbnail?.let { thumb ->
                            TgThumbnail(
                    ...
                    minithumbnail =
                        content.video.minithumbnail?.let { mini ->
                            TgMinithumbnail(
                                width = mini.width,
                                height = mini.height,
                                data = mini.data,
            ...
            is MessageAudio ->
                TgContent.Audio(
                    ...
                    albumCoverThumbnail =
                        content.audio.albumCoverThumbnail?.let { thumb ->
                            TgThumbnail(
                                fileId = thumb.file.id,
                                remoteId = thumb.file.remote?.id ?: "",
                                width = thumb.width,
                    ...
                    albumCoverMinithumbnail =
                        content.audio.albumCoverMinithumbnail?.let { mini ->
                            TgMinithumbnail(
                                width = mini.width,
                                height = mini.height,
                                data = mini.data,
            ...
            is MessageDocument ->
                TgContent.Document(
                    ...
                    remoteId =
                        content.document.document.remote
                            ?.id ?: "",
                    ...
                    thumbnail =
                        content.document.thumbnail?.let { thumb ->
                            TgThumbnail(
                                fileId = thumb.file.id,
                                remoteId = thumb.file.remote?.id ?: "",
                                width = thumb.width,
                    ...
                    minithumbnail =
                        content.document.minithumbnail?.let { mini ->
                            TgMinithumbnail(
                                width = mini.width,
                                height = mini.height,
                                data = mini.data,
            ...
            is MessagePhoto ->
                TgContent.Photo(
                    ...
                    caption = content.caption.text,
                    minithumbnail =
                        content.photo.minithumbnail?.let { mini ->
                            TgMinithumbnail(
                                width = mini.width,
                                height = mini.height,
                                data = mini.data,
            ...
            is MessageAnimation ->
                TgContent.Animation(
                    ...
                    remoteId =
                        content.animation.animation.remote
                            ?.id ?: "",
                    ...
                    caption = content.caption.text,
                    thumbnail =
                        content.animation.thumbnail?.let { thumb ->
                            TgThumbnail(
                                fileId = thumb.file.id,
                                remoteId = thumb.file.remote?.id ?: "",
                                width = thumb.width,
                    ...
                    minithumbnail =
                        content.animation.minithumbnail?.let { mini ->
                            TgMinithumbnail(
                                width = mini.width,
                                height = mini.height,
                                data = mini.data,
            ...
            is MessageVideoNote ->
                TgContent.VideoNote(
                    ...
                    minithumbnail =
                        content.videoNote.minithumbnail?.let { mini ->
                            TgMinithumbnail(
                                width = mini.width,
                                height = mini.height,
                                data = mini.data,
            ...
            is MessageVoiceNote ->
                TgContent.VoiceNote(
                    ...
                    remoteId =
                        content.voiceNote.voice.remote
                            ?.id ?: "",
