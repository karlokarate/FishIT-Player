...
data class TelegramLoggingConfig(
    ...
    companion object {
        ...
        fun forEnvironment(isDebug: Boolean): TelegramLoggingConfig = if (isDebug) verbose() else quiet()

        fun verbose(): TelegramLoggingConfig =
            TelegramLoggingConfig(
                enabled = true,
                maxVerbosity = TdLibLogVerbosity.VERBOSE,
            )

        fun quiet(): TelegramLoggingConfig =
            TelegramLoggingConfig(
                enabled = true,
