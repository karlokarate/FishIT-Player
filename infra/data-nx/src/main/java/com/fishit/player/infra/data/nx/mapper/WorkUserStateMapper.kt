 ...
 */
@Singleton
class WorkUserStateMapper @Inject constructor() {
     ...
     */
    fun toDomain(entity: NX_WorkUserState): WorkUserState =
        toDomain(entity) { profileId -> profileId.toString() }
    ...
    fun toEntity(
        ...
        existingId: Long = 0L,
    ): NX_WorkUserState = NX_WorkUserState(
        id = existingId,
