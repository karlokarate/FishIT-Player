 ...
 */
@Singleton
class NxProfileUsageRepositoryImpl
    @Inject
    constructor(
        boxStore: BoxStore,
        ...
        override suspend fun get(
            ...
            withContext(Dispatchers.IO) {
                ...
                box
                    .query(NX_ProfileUsage_.profileId.equal(profile.id))
                    .and()
        ...
        override suspend fun upsert(day: UsageDay): UsageDay =
            withContext(Dispatchers.IO) {
                val profile =
                    profileBox
                        .query(NX_Profile_.profileKey.equal(day.profileKey, StringOrder.CASE_SENSITIVE))
                        .build()
