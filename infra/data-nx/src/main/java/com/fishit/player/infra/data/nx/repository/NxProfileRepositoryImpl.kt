...
class NxProfileRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun get(profileKey: String): Profile? =
        ...
        override suspend fun upsert(profile: Profile): Profile =
            withContext(Dispatchers.IO) {
                val existing =
                    box
                        .query(NX_Profile_.profileKey.equal(profile.profileKey, StringOrder.CASE_SENSITIVE))
                        .build()
                        .findFirst()
        ...
        override suspend fun softDelete(profileKey: String): Boolean =
            withContext(Dispatchers.IO) {
