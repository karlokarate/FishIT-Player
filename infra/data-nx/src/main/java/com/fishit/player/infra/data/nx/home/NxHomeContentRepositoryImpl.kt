...
@Singleton
class NxHomeContentRepositoryImpl
    @Inject
    constructor(
        ...
        override fun observeRecentlyAdded(): Flow<List<HomeMediaItem>> {
            ...
            return workRepository
                .observeRecentlyCreated(limit = ContentDisplayLimits.RECENTLY_ADDED)
                .mapLatest { works ->
        ...
        try {
            ...
            val options =
                NxWorkRepository.QueryOptions(
                    ...
                    sortField = sortField,
                    sortDirection =
                        if (sortField == NxWorkRepository.SortField.RECENTLY_ADDED) {
