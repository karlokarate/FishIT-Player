 ...
 */
@Singleton
class NxWorkVariantDiagnosticsImpl
    @Inject
    constructor(
        ...
        override suspend fun findOrphanedVariants(limit: Int): List<Variant> =
            withContext(Dispatchers.IO) {
        ...
        override suspend fun findVariantsMissingPlaybackHints(limit: Int): List<Variant> =
            withContext(Dispatchers.IO) {
                box.all
        ...
        override suspend fun countVariantsMissingPlaybackHints(): Long =
            withContext(Dispatchers.IO) {
