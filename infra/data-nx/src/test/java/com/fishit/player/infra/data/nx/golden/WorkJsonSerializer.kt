...
object WorkJsonSerializer {
     ...
     */
    fun toJsonElement(work: NxWorkRepository.Work): JsonElement =
        buildJsonObject {
            // === Identity ===
     ...
     */
    fun toJsonString(work: NxWorkRepository.Work): String = json.encodeToString(JsonElement.serializer(), toJsonElement(work))
