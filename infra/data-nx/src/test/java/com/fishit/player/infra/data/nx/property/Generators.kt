...
object Generators {
    ...
    val telegramSourceId: Arb<String> =
        Arb.bind(
    ...
    val httpImageRef: Arb<ImageRef.Http> =
        Arb.bind(
            Arb.of(
    ...
    val telegramThumbRef: Arb<ImageRef.TelegramThumb> =
        Arb.bind(
    ...
    val externalIds: Arb<ExternalIds> =
        Arb.bind(
            tmdbRef,
    ...
    val playbackHints: Arb<Map<String, String>> =
        Arb.of(
            emptyMap(),
     ...
     */
    val rawMediaMetadata: Arb<RawMediaMetadata> =
        Arb.bind(
            title,
            mediaType,
            year,
