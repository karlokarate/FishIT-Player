...
class NxCatalogWriterVodE2ETest {
    ...
    @Test
    fun `VOD LIST - basic fields flow to NX_Work`() =
        runBlocking {
    ...
    @Test
    fun `VOD DETAIL - rich metadata flows to NX_Work`() =
        runBlocking {
    ...
    @Test
    fun `VOD - timestamps are correctly mapped`() =
        runBlocking {
...
class NxCatalogWriterSeriesE2ETest {
    ...
    @Test
    fun `SERIES - basic fields flow to NX_Work`() =
        runBlocking {
            val raw =
                RawMediaMetadata(
    ...
    @Test
    fun `EPISODE - fields flow correctly including season and episode number`() =
        runBlocking {
            val raw =
                RawMediaMetadata(
...
class NxCatalogWriterLiveE2ETest {
    ...
    @Test
    fun `LIVE - channel fields flow to NX_Work and NX_WorkSourceRef`() =
        runBlocking {
            val raw =
                RawMediaMetadata(
    ...
    @Test
    fun `LIVE - channel without EPG has null epgChannelId`() =
        runBlocking {
            val raw =
                RawMediaMetadata(
...
class NxCatalogWriterPlaybackHintsE2ETest {
    ...
    @Test
    fun `PlaybackHints are preserved in NX_WorkVariant for VOD URL construction`() =
        runBlocking {
            val playbackHints =
                mapOf(
                    "xtream.containerExtension" to "mkv",
    ...
    @Test
    fun `No Variant created when playbackHints are empty`() =
        runBlocking {
            val raw =
                RawMediaMetadata(
