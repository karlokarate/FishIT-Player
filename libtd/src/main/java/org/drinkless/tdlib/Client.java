...
public final class Client {
    static {
        // Ensure the native TDLib JNI is loaded before any native method is called.
        // If the library is missing for the current ABI, TDLib usage will fail fast.
        try {
            System.loadLibrary("tdjni");
        } catch (Throwable ignored) {
            // Deliberately ignore here; callers will observe UnsatisfiedLinkError
            // on first native usage if the library is unavailable.
        }
    }
    /**
