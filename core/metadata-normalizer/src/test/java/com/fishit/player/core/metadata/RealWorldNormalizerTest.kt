...
class RealWorldNormalizerTest {
    ...
    @Test
    fun `normalize 50 realistic Telegram inputs`() =
        runTest {
            var successCount = 0
    ...
    @Test
    fun `normalize 50 realistic Xtream inputs`() =
        runTest {
            var successCount = 0
            val failures = mutableListOf<String>()
    ...
    @Test
    fun `all inputs produce non-empty canonical title`() =
        runTest {
    ...
    @Test
    fun `normalizer is deterministic - same input produces same output`() =
        runTest {
            val testInputs =
                listOf(
    ...
    @Test
    fun `mediaType is correctly inferred`() =
        runTest {
