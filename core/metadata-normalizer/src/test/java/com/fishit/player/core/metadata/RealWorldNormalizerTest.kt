...
class RealWorldNormalizerTest {
    ...
    private val telegramInputs = listOf(
        // === Movie Filenames (typical Telegram movie channels) ===
        "Inception 2010 German DL 1080p BluRay x264-EXQUiSiTE.mkv" to Expected("Inception", 2010),
        "Der.Herr.der.Ringe.Die.Gefaehrten.Extended.2001.German.DL.1080p.BluRay.x264.mkv" to Expected("Herr der Ringe", 2001),
        "Interstellar (2014) German DL 2160p UHD BluRay HDR HEVC-NIMA4K.mkv" to Expected("Interstellar", 2014),
        "Oppenheimer.2023.German.DL.EAC3.1080p.AMZN.WEB.H265-ZeroTwo.mkv" to Expected("Oppenheimer", 2023),
        "Dune Part Two (2024) German DL 1080p WEB x264.mkv" to Expected("Dune Part Two", 2024),
        "Avatar.2009.German.DL.2160p.UHD.BluRay.HDR.x265-NIMA4K.mkv" to Expected("Avatar", 2009),
        "Barbie.2023.German.DL.1080p.BluRay.x264-LizardSquad.mkv" to Expected("Barbie", 2023),
        "John Wick Kapitel 4 2023 German DL 1080p BluRay x264.mkv" to Expected("John Wick", 2023),
        "Spider-Man Across the Spider-Verse 2023 German DL 1080p BluRay.mkv" to Expected("Spider-Man", 2023),
        "Gladiator (2000) German DL Extended Edition 1080p BluRay.mkv" to Expected("Gladiator", 2000),
        ...
        // === German Movies ===
        "Der Schuh des Manitu 2001 German 1080p BluRay.mkv" to Expected("Schuh des Manitu", 2001),
        "Fack ju Göhte 2013 German DL 1080p BluRay x264.mkv" to Expected("Fack ju Göhte", 2013),
        ...
        "Good Bye Lenin 2003 German 1080p BluRay.mkv" to Expected("Good Bye Lenin", 2003),
        "Das Leben der Anderen 2006 German 1080p BluRay x264.mkv" to Expected("Leben der Anderen", 2006),
        
        // === Series with SxxEyy format ===
        "Breaking Bad S05E16 Felina German DL 1080p BluRay x264.mkv" to Expected("Breaking Bad", null, 5, 16),
        "Game of Thrones S08E06 German DL 1080p WEB.mkv" to Expected("Game of Thrones", null, 8, 6),
        "Stranger Things S04E09 German DL 1080p WEB.mkv" to Expected("Stranger Things", null, 4, 9),
        "The Witcher S03E08 German DL 1080p NF WEB.mkv" to Expected("Witcher", null, 3, 8),
        "House of the Dragon S02E08 German DL 1080p WEB.mkv" to Expected("House of the Dragon", null, 2, 8),
        "Dark S03E08 German DL 1080p NF WEB.mkv" to Expected("Dark", null, 3, 8),
        "Babylon Berlin S04E12 German DL 1080p WEB.mkv" to Expected("Babylon Berlin", null, 4, 12),
        
        // === Series with German "Folge" format ===
        "Doctor Snuggles - S01 E12 - Die Reise nach Nirgendwo.mp4" to Expected("Doctor Snuggles", null, 1, 12),
        "PAW Patrol Folge 103 - Der Wüstensturm.mp4" to Expected("PAW Patrol", null, null, 103),
        "Die Sendung mit der Maus - Folge 2547.mp4" to Expected("Sendung mit der Maus", null, null, 2547),
        
        // === Anime ===
        "[SubsPlease] One Piece - 1089 (1080p) [E1A86634].mkv" to Expected("One Piece", null, null, 1089),
        "[Erai-raws] Jujutsu Kaisen 2nd Season - 23 [1080p][HEVC].mkv" to Expected("Jujutsu Kaisen", null, null, 23),
        "Demon Slayer Kimetsu no Yaiba S04E11 German Dub 1080p.mkv" to Expected("Demon Slayer", null, 4, 11),
        "Attack on Titan S04E28 German DL 1080p WEB.mkv" to Expected("Attack on Titan", null, 4, 28),
        "Dragon Ball Super - 131 (1080p).mkv" to Expected("Dragon Ball Super", null, null, 131),
        
        // === Telegram channel tags ===
        "@GermanMovies - Inception 2010 German DL 1080p.mkv" to Expected("Inception", 2010),
        ...
        "@SerienChannel Breaking Bad S05E16.mkv" to Expected("Breaking Bad", null, 5, 16),
        
        // === Compressed archives (common on Telegram) ===
        "LEGO Ninjago Special 002 Tag der Erinnerungen.7z" to Expected("LEGO Ninjago", null),
        ...
        "The Batman 2022 German DL 2160p UHD BluRay Dolby Vision.mkv" to Expected("Batman", 2022),
        "Top Gun Maverick 2022 German DL 2160p UHD BluRay TrueHD Atmos.mkv" to Expected("Top Gun Maverick", 2022),
        
        // === Edge cases ===
        "1917 2019 German DL 1080p BluRay.mkv" to Expected("1917", 2019),
        "300 2006 German DL 1080p BluRay.mkv" to Expected("300", 2006),
        "2001 A Space Odyssey 1968 German DL 1080p BluRay.mkv" to Expected("Space Odyssey", 1968),
    ...
    private val xtreamInputs = listOf(
        ...
        "VOD|DE| Wer Früher Stirbt Ist Länger Tot 2006" to Expected("Wer Früher Stirbt", 2006),
        ...
        "[4K][N][2023]| Oppenheimer (2023) - tmdb-872585" to Expected("Oppenheimer", 2023),
        ...
        "Dune Part Two 2024 2160p WEB-DL DDP5.1 Atmos x265-FLUX" to Expected("Dune Part Two", 2024),
        "The Batman 2022 REMASTERED 1080p BluRay x264 DTS-HD MA 7.1-FGT" to Expected("Batman", 2022),
        "Top Gun Maverick 2022 IMAX UHD BluRay 2160p TrueHD Atmos 7.1 DV HEVC REMUX-FraMeSToR" to Expected("Top Gun Maverick", 2022),
        
        // === Series with provider tags ===
        "N| House of the Dragon S01E01 2022" to Expected("House of the Dragon", 2022, 1, 1),
        ...
        "IT | Il Commissario Montalbano S15E01" to Expected("Commissario Montalbano", null, 15, 1),
        ...
        "[[[[N]]]][[[FHD]]] Another Movie 2021 [[[DE]]]" to Expected("Another Movie", 2021),
    ...
    fun `normalize 50 realistic Telegram inputs`() = runTest {
        ...
        for ((input, expected) in telegramInputs) {
            ...
            try {
                ...
                assertTrue(
                    normalized.canonicalTitle.contains(expected.titleContains, ignoreCase = true),
    ...
    fun `normalize 50 realistic Xtream inputs`() = runTest {
        ...
        for ((input, expected) in xtreamInputs) {
            ...
            try {
                ...
                // Note: We only check for tags with pipe separators, not bare words like "Movie" or "Film"
                assertFalse(
                    normalized.canonicalTitle.matches(Regex(".*[|]\\s*(N|NF|D|DE|EN|FHD|4K|UHD|HD|SD|VOD|MOVIE|FILM|SERIE|TV)\\s*[|]?.*", RegexOption.IGNORE_CASE)),
    ...
    fun `mediaType is correctly inferred`() = runTest {
        ...
        val seriesRaw = RawMediaMetadata(
