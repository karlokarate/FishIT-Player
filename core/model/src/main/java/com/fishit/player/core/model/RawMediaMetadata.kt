 ...
 * @property durationMs Media runtime in **milliseconds** (v2 standard). Pipelines convert from
 * source units.
...
data class RawMediaMetadata(
         ...
         *
         * **v2 Standard:** All durations in RawMediaMetadata are stored as milliseconds. Pipelines
         ...
         *
         * Structured Telegram bundles provide this directly (fsk field). Range: 0-21 (per Schema
         * Guards in TELEGRAM_STRUCTURED_BUNDLES_CONTRACT.md R4). 0 = FSK 0 (all ages), 6/12/16/18 =
         * FSK ratings, 21 = explicit adult.
         *
         * Used for:
         ...
         *
         * Xtream provides this from API ("plot" field). Telegram structured bundles may provide
         * this. Passed through to canonical storage for display in detail screens.
         */
        val plot: String? = null,
        /**
         * Comma-separated genre list from source.
         *
         * Xtream provides this from API ("genre" field). Example: "Action, Sci-Fi, Thriller"
         */
         ...
         *
         * Xtream provides this from API ("cast" field). Example: "Tom Hanks, Robin Wright, Gary
         * Sinise"
         */
        val cast: String? = null,
        /**
         * Trailer URL from source.
         *
         * Xtream provides this from API (youtube_trailer, trailer, etc.). May be a YouTube URL or
         * video ID.
         */
    ...
    companion object {
        ...
        fun fromLegacyTmdbId(
            ...
            return if (tmdbRef != null) {
                ...
                @Suppress("DEPRECATION") ExternalIds(legacyTmdbId = tmdbId)
            }
        }
    }
}
