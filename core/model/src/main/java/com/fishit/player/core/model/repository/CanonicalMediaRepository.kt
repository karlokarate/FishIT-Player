...
interface CanonicalMediaRepository {
     ...
     *
     * For DETAILS_BY_ID enrichment: these items have a TMDB ID but haven't been enriched with full
     * details yet.
     *
     ...
     *
     * Respects cooldown: only returns items where tmdbNextEligibleAt <= now. For SEARCH_MATCH
     * resolution path.
     *
     * @param limit Maximum number of candidates to return
