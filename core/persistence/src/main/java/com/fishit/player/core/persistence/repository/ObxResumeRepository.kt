...
import com.fishit.player.core.persistence.obx.ObxResumeMark_
...
class ObxResumeRepository
    ...
    constructor(
        ...
        override suspend fun clearOldResumePositions(olderThanMs: Long) =
            withContext(Dispatchers.IO) {
                val old =
                    resumeBox
                        .query(ObxResumeMark_.updatedAt.less(olderThanMs))
                        .build()
                        .find()
        ...
        private fun PlaybackType.toObxType() =
            when (this) {
