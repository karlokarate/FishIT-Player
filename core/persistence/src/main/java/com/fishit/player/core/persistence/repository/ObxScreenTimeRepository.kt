...
import com.fishit.player.core.persistence.obx.ObxScreenTimeEntry_
...
class ObxScreenTimeRepository
    ...
    constructor(
        ...
        override suspend fun clearOldEntries(olderThanYyyymmdd: String): Unit =
            withContext(Dispatchers.IO) {
                val old =
                    screenTimeBox
                        .query(ObxScreenTimeEntry_.dayYyyymmdd.less(olderThanYyyymmdd))
                        .build()
                        .find()
