...
class ObjectBoxIntrospectionDumpTest {
    ...
    @Test
    fun testGenerateDump_producesValidSchema() = runBlocking {
    ...
    @Test
    fun testGenerateDump_containsExpectedEntities() = runBlocking {
        // When: Generate schema dump
        val dump = ObjectBoxIntrospectionDump.generateDump(boxStore)
    ...
    @Test
    fun testGenerateDump_extractsProperties() = runBlocking {
        // When: Generate schema dump
        val dump = ObjectBoxIntrospectionDump.generateDump(boxStore)
    ...
    @Test
    fun testDumpToFile_createsValidFile() = runBlocking {
    ...
    @Test
    fun testDumpToLogcat_doesNotCrash() = runBlocking {
    ...
    @Test
    fun testEntityDump_containsDisplayName() = runBlocking {
        // When: Generate schema dump
        val dump = ObjectBoxIntrospectionDump.generateDump(boxStore)
    ...
    @Test
    fun testPropertyDump_containsAnnotations() = runBlocking {
        // When: Generate schema dump
        val dump = ObjectBoxIntrospectionDump.generateDump(boxStore)
